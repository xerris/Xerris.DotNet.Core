 ...
 public static class ObjectExtensions
    {
        ...
        {
            var result = ReflectionEquals(o1, o2, new List<object>(), throwException, typeof(IgnoreForReflectionEqualsAttribute));
        ...
        public static bool ReflectionEquals(object o1, object o2, List<object> objectsAlreadyCompared, bool throwException, params Type[] attributeTypesOnPropertiesToIgnore)
        {
            ...
            return propertiesToCompare.All(x =>
            {
                ...
                {
                    if (throwException)
                        throw new ArgumentException($"Property {x.Name} - Objects:\n{o1}\nvs\n{o2}:\nOne is null while the other isn't:\n{o1Value.Stringify()}\n vs \n{o2Value.Stringify()}");
                    return o2Value == null;
                }
                ...
                var result = o1Value is ValueType ?
                    ...
                    ReferenceEquals(o1Value, o2Value) || o1Value.Equals(o2Value) || ReflectionEquals(o1Value, o2Value, objectsAlreadyCompared, throwException, attributeTypesOnPropertiesToIgnore);

                if (!result && throwException)
                    throw new ArgumentException($"Values not equal for property {x.Name} of objects\n{o1}\nand\n{o2}\n:\n{o1Value.Stringify()}\n vs \n{o2Value.Stringify()}");
                return result;
            });
        }
        ...
        private static bool CollectionEquals(IEnumerable o1Value, IEnumerable o2Value, List<object> objectsAlreadyCompared, bool throwException, Type[] attributeTypesOnPropertiesToIgnore)
        {
            ...
            {
                if (ReflectionEquals(enumerator1.Current, enumerator2.Current, objectsAlreadyCompared, throwException, attributeTypesOnPropertiesToIgnore))
                    continue;
                if (throwException)
