...
namespace Xerris.DotNet.Core.Extensions
{
    public static class DateTimeExtensions
    {
        ...
        public static DateTime TruncateMilliseconds(this DateTime dateTime)
            => new(dateTime.Year, dateTime.Month, dateTime.Day, dateTime.Hour, dateTime.Minute,
        ...
        public static DateTime Latest(this DateTime value)
            => new DateTime(value.Year, value.Month, value.Day, 23, 59, 59, 999);
        ...
        public static DateTime UtcTruncateSeconds(this DateTime timeToTruncate)
            => new(timeToTruncate.Year, timeToTruncate.Month, timeToTruncate.Day, timeToTruncate.Hour,
                timeToTruncate.Minute, 0, 0, DateTimeKind.Utc);
        
        public static DateTime UtcTruncateMilliseconds(this DateTime timeToTruncate)
            => new(timeToTruncate.Year, timeToTruncate.Month, timeToTruncate.Day, timeToTruncate.Hour, timeToTruncate.Minute, timeToTruncate.Second, 0,
                DateTimeKind.Utc);
