...
namespace Xerris.DotNet.Core.Extensions
{
    public static class EnumerableExtensions
    {
        ...
        public static string GetEmail(this IEnumerable<string> items)
        {
            ...
            return items.FirstOrDefault(x => emailRegex.IsMatch(x));
        }
    }
}